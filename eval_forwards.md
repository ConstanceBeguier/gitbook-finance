...
Notations:
 ...
 - $$T$$: délai en année entre $$t_0$$ la date de la transaction et la date de la livraison
...
Si $$F_0 > (S_0 - V e^{-rT_V}) * e^{rT}$$, un arbitragiste fera les opérations suivantes:
 ...
 - à $$t_0 + T_V$$
   ...
   - remboursement de l'emprunt $$E_1$$ grâce au flux (montant à rembourser: $$V e^{-rT_V} e^{rT_V} = V$$)
 - à $$t_0 + T$$
   - dénouement du contrat: vente de l'actif au prix $$F_0$$
   - remboursement de l'emprunt $$E_2$$ (montant à rembourser: $$(S_0 - Ve^{-rT_V})e^{rT}$$)
...
Si $$F_0 < (S_0 - V e^{-rT_V}) e^{rT}$$, un arbitragiste fera les opérations suivantes:
 ...
 - à $$t_0 + T_V$$
   - paiement du flux $$V$$
   - encaissement du placement $$P_1$$ (montant à encaisser: $$V e^{-rT_V} e^{rT_V} = V$$)
 - à $$t_0 + T$$
   - dénouement du contrat: achat de l'actif au prix $$F_0$$
   - encaissement du placement $$P_2$$ (montant à encaisser: $$(S_0 - Ve^{-rT_V})e^{rT}$$)
...
Si l'arbitragiste détient 1000 unités d'une devise étrangère qu'il aimerait convertir en dollars US à la date $$t_0 + T$$.
 ...
 - Deuxième méthode:
   ...
   - à $$t_0 + T$$
     - encaissement du placement: $$1000 \cdot S_0 * e^{rT}$$ dollars US
   - l'arbitragiste obtient donc $$1000 \cdot S_0 * e^{rT}$$ dollars US 
